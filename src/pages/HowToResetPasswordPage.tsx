...
export default function HowToResetPasswordPage() {
  return (
    <main className="page-with-header min-h-screen bg-black">
      <Container className="max-w-3xl py-10 sm:py-14 md:py-16">
